...
from app.modules.consultant.schemas import ConsultantProfileCreate, ConsultantProfileUpdate, ConsultantDocumentCreate
from app.modules.consultant.services.consultant import (
    upsert_my_profile,
    update_my_profile,
    search_consultants,
    get_profile_public,
