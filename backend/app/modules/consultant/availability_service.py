...
from app.modules.consultant.models import ConsultantProfile, ConsultantAvailabilityRule
from app.modules.consultant.models import AvailabilityRuleCreate, AvailabilityRuleUpdate
