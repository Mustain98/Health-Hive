...
def list_my_availability_rules(session: Session, consultant: User):
    ...
    from app.modules.consultant.availability_service import list_rules
    ...
    from app.modules.consultant.models import ConsultantAvailabilityRule as AvailabilityRuleRead
    return [
...
def create_availability_rule(session: Session, consultant: User, rule_data):
    ...
    from app.modules.consultant.availability_service import create_rule
    from fastapi import HTTPException
...
def update_availability_rule(session: Session, consultant: User, rule_id: int, updates):
    ...
    from app.modules.consultant.availability_service import update_rule
    from fastapi import HTTPException
...
def delete_availability_rule(session: Session, consultant: User, rule_id: int):
    ...
    from app.modules.consultant.availability_service import delete_rule
    from fastapi import HTTPException
