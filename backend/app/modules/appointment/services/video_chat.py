...
from app.modules.appointment.models import SessionStatus
from app.modules.appointment.services.session import _get_appointment, _get_room_by_appointment
