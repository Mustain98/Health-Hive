...
from app.modules.appointment.models import AppointmentApplication, Appointment, SessionRoom
from app.modules.appointment.models import AppointmentApplicationCreate, AppointmentSchedule
...
def apply_me(session: Session, me: User, payload: AppointmentApplicationCreate) -> AppointmentApplication:
    from app.modules.appointment.user_side_appointment_service import apply_for_appointment
...
def consultant_appointments(session: Session, consultant: User):
    from app.modules.appointment.models import AppointmentReadWithUser
...
def user_accept_proposal_controller(session: Session, me: User, application_id: int) -> AppointmentApplication:
    from app.modules.appointment.user_side_appointment_service import user_accept_proposal
...
def user_cancel_application(session: Session, me: User, application_id: int) -> AppointmentApplication:
    from app.modules.appointment.user_side_appointment_service import cancel_application
