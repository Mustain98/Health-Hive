...
from app.modules.appointment.models import FollowUpRoom, FollowUpMessage, TimeProposal
from app.modules.appointment.schemas import FollowUpMessageRead, FollowUpRoomRead, TimeProposalRead, SendMessageRequest, CreateProposalRequest
...
def create_from_session(
    ...
    """
    from app.modules.appointment.services.followup import create_followup_from_session, _enrich_room
...
def list_my_rooms(
    ...
    from app.modules.appointment.services.followup import list_rooms_for_user
...
def get_room(
    ...
    from app.modules.appointment.services.followup import get_room_detail
...
def cancel_room(
    ...
    from app.modules.appointment.services.followup import cancel_followup, _enrich_room
...
def get_sessions(
    ...
    """
    from app.modules.appointment.services.followup import list_sessions_for_room
...
def get_patient_summary(
    ...
    """Consultant-only: returns patient UserData, active Milestone, active NutritionTarget."""
    from app.modules.appointment.services.followup import get_patient_summary as svc
...
def get_my_summary(
    ...
    """User-only: returns their own UserData, active Milestone, NutritionTarget, and Goal Logs."""
    from app.modules.appointment.services.followup import get_my_summary as svc
    return svc(session, room_id, me.id)
...
def get_messages(
    ...
    from app.modules.appointment.services.followup import list_messages
...
def send_message(
    ...
    from app.modules.appointment.services.followup import post_message
...
def get_proposals(
    ...
    from app.modules.appointment.services.followup import list_proposals
...
def create_proposal(
    ...
    from app.modules.appointment.services.followup import create_proposal as svc_create
...
def accept_proposal(
    ...
    from app.modules.appointment.services.followup import accept_proposal as svc_accept
...
def reject_proposal(
    ...
    from app.modules.appointment.services.followup import reject_proposal as svc_reject
...
def cancel_proposal(
    ...
    from app.modules.appointment.services.followup import cancel_proposal as svc_cancel
