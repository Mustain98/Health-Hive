...
from app.modules.appointment.schemas import AppointmentWithParticipants, AppointmentDetailsResponse
from app.modules.appointment.controllers.appointment import (
...
def list_my_appts(
    ...
    from app.modules.appointment.controllers.appointment import search_appointments_controller
...
def get_appointment_details(
    ...
    from app.modules.appointment.controllers.appointment import get_appointment_details_controller
...
def toggle_permission(
    ...
    from app.modules.appointment.controllers.appointment import toggle_permission_controller
...
def list_consultant_appts(
    ...
    from app.modules.appointment.controllers.appointment import consultant_search_appointments_controller
...
def get_consultant_history(
    ...
    from app.modules.appointment.controllers.appointment import get_consultant_history_controller
...
def get_user_history(
    ...
    from app.modules.appointment.controllers.appointment import get_user_history_controller
