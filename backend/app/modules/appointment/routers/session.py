...
from app.modules.appointment.schemas import ChatMessageCreate, SessionNoteCreate
from app.modules.appointment.models import ChatMessage, SessionNote, SessionRoom
from app.modules.appointment.controllers.session import (
    send_message,
    history,
    write_note,
    read_note,
...
def get_appointment_messages(
    ...
    from app.modules.appointment.controllers.appointment import get_room_id_for_appointment
    try:
...
def get_client_health_data(
    ...
    from app.modules.appointment.controllers.session import fetch_client_health
