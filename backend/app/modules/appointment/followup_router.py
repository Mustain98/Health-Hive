...
def create_from_session(
    ...
    """
    from app.modules.appointment.followup_service import create_followup_from_session, _enrich_room
...
def list_my_rooms(
    ...
    from app.modules.appointment.followup_service import list_rooms_for_user
...
def get_room(
    ...
    from app.modules.appointment.followup_service import get_room_detail
...
def cancel_room(
    ...
    from app.modules.appointment.followup_service import cancel_followup, _enrich_room
...
def get_sessions(
    ...
    """
    from app.modules.appointment.followup_service import list_sessions_for_room
...
def get_patient_summary(
    ...
    from app.modules.appointment.followup_service import get_patient_summary as svc
...
def get_my_summary(
    ...
    from app.modules.appointment.followup_service import get_my_summary as svc
    return svc(session, room_id, me.id)
...
def get_messages(
    ...
    from app.modules.appointment.followup_service import list_messages
...
def send_message(
    ...
    from app.modules.appointment.followup_service import post_message
...
def get_proposals(
    ...
    from app.modules.appointment.followup_service import list_proposals
...
def create_proposal(
    ...
    from app.modules.appointment.followup_service import create_proposal as svc_create
...
def accept_proposal(
    ...
    from app.modules.appointment.followup_service import accept_proposal as svc_accept
...
def reject_proposal(
    ...
    from app.modules.appointment.followup_service import reject_proposal as svc_reject
...
def cancel_proposal(
    ...
    from app.modules.appointment.followup_service import cancel_proposal as svc_cancel
