...
from app.modules.appointment.session_service import (
    post_message,
    list_messages,
    upsert_note,
    get_note,
...
def fetch_client_health(session: Session, appointment_id: int, consultant_user_id: int):
    from app.modules.appointment.session_service import get_client_health
...
def grant_session_permission(session: Session, appointment_id: int, user_id: int, scope: str, resources: list[str]):
    from app.modules.appointment.session_service import manage_session_permission
...
def get_session_permission(session: Session, appointment_id: int, user_id: int):
    from app.modules.appointment.session_service import list_session_permissions
